...
import harmonic_wave_train as train_module
...
FIG_DIR = os.path.join(BASE_DIR, "harmonic_wave_figures")
REPORT_DIR = os.path.join(BASE_DIR, "harmonic_wave_reports")
...
def predict_at_time(x_values, t):
    ...
    with torch.no_grad():
        ...
        exact = train_module.exact_solution(x, time).squeeze(1)
...
def save_metrics(metrics):
    ...
    with open(path, "w", encoding="utf-8") as file:
        file.write("Harmonic wave PINN error metrics\n")
        file.write("================================\n")
